...
contract ClickGemToken is Owned {
    ...
    function freezeTransfers() public onlyOwner returns (bool success) {
        tokenIsFrozen = true;
        emit FreezeTransfers(msg.sender, true);
        return true;
    }

    function unFreezeTransfers() public onlyOwner returns (bool success) {
        tokenIsFrozen = false;
        emit UnFreezeTransfers(msg.sender, true);
        return true;
    }
